...
@section('titlebar_actions')
    <x-button
        ...
        href="{{ $app_is_demo ? '#' : route('dashboard.admin.frontend.generatorlist.createOrUpdate') }}"
    >
                        ...
                        <td class="whitespace-nowrap text-end">
                            ...
                            @else
                                <x-button
                                    ...
                                    variant="ghost-shadow"
                                    size="none"
                                    href="{{ route('dashboard.admin.frontend.generatorlist.createOrUpdate', $entry->id) }}"
                                    title="{{ __('Edit') }}"
                                >
                                    <x-tabler-pencil class="size-4" />
                                </x-button>
                                <x-button
                                    ...
                                    href="{{ route('dashboard.admin.frontend.generatorlist.delete', $entry->id) }}"
                                    title="{{ __('Delete') }}"
                                >
                                    <x-tabler-x class="size-4" />
                                </x-button>
