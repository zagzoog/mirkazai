                        ...
                        <tr>
                            ...
                            <td class="text-end">
                                <x-button
                                        ...
                                        size="none"
                                        title="{{ __('Assistant Training') }}"
                                        :href="route('dashboard.admin.ai-assistant.edit', $assistant['id'])"
                                >
                                    <svg width="17" height="16" viewBox="0 0 17 16" fill="none"
                                        ...
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                              ...
                                              fill="url(#paint0_linear_3314_1636)"></path>
                                        <defs>
                                            <linearGradient id="paint0_linear_3314_1636" x1="1.03221e-07" y1="3.30635"
                                                            x2="13.3702" y2="15.6959" gradientUnits="userSpaceOnUse">
                                ...
                                <x-button
                                        ...
                                        size="none"
                                        title="{{ __('Delete') }}"
                                        onclick="confirmDelete('{{ route('dashboard.admin.ai-assistant.destroy', $assistant['id']) }}')"
                                >
...
@push('script')
    <script>
        function confirmDelete(url) {
            if (confirm('<?php echo e(__('Are you sure you want to delete the chatbot?')); ?>')) {
                $.ajax({
                    type: "DELETE",
                    url: url,
