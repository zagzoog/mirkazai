        ...
        <div class="container-xl">
            <div class="row row-cards">
                <div class="col-sm-8 col-lg-8">
                    ...
                    <form
                        id="payment-form"
                        action="{{ route('dashboard.user.payment.prepaid.checkout', ['gateway' => 'stripe']) }}"
                        method="post"
                    >
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 col-xl-12">
                                ...
                                @if ($app_is_demo)
                                    ...
                                    >
                                        <div class="w-100 justify-cetner flex items-center">
                                            <div
                                ...
                                @else
                                    <x-button
                                        ...
                                        type="submit"
                                    >
                                        <span class="justify-cetner flex items-center">
                                            <div
                                                class="spinner hidden"
                                                id="spinner"
                                            ></div>
                ...
                if (typeof rewardful !== 'undefined') {
                    rewardful('ready', function() {
                        if (Rewardful.referral) {
                            url =
                                `{{ route('dashboard.user.payment.prepaid.checkout', ['gateway' => ':gateway'], ['referral' => ':referral']) }}`;
