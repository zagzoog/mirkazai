...
>
    ...
    >
        ...
        >
            ...
            <div class="mt-8">
                @if (View::exists('panel.user.article_wizard.components.article_result') && setting('serper_seo_aw_anlyze', 0))
                    @include('panel.user.article_wizard.components.article_result')
                @else
                    <div class="w-full pe-5 ps-2">
