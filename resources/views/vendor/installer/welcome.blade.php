...
@section('container')
    <div class="mx-auto w-4/5">
        ...
        <p class="mb-20 text-[20px]">{{ __('Thanks for purchasing MirkazAI! You can now install your product in seconds and unlock the magic of AI. Let’s get you started!') }}</p>
