...
>
    ...
    <form
            ...
            target="{{ $target }}"
    >
        <h2 class="mb-9 text-[36px] font-bold tracking-[-0.015em]">{{ __($text . ' your license') }} </h2>
        ...
        <div class="mb-4 text-heading-foreground">
            <p class="mb-[0.65rem] text-[15px] font-bold">{{ __('Choose your enviroment:') }}</p>
