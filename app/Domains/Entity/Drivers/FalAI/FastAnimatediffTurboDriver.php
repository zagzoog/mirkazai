...
class FastAnimatediffTurboDriver extends BaseDriver implements WithInputVideoInterface, WithVideoToVideoInterface
{
    use HasInputVideo;
    use HasVideoToVideo;
    ...
    {
        return EntityEnum::FAST_ANIMATEDIFF_TURBO;
    }
}
