...
class AnthropicClaude35Haiku20241022SelfModerated extends BaseDriver implements WithInputInterface, WithWordsInterface
{
    use HasInput;
    use HasWords;
    ...
    {
        return EntityEnum::ANTHROPIC_CLAUDE_3_5_HAIKU_20241022_SELF_MODERATED;
    }
}
