...
class PerplexityLlama31Sonar405BOnline extends BaseDriver implements WithInputInterface, WithWordsInterface
{
    use HasInput;
    use HasWords;
    ...
    {
        return EntityEnum::PERPLEXITY_LLAMA_31_SONAR_405B_ONLINE;
    }
}
