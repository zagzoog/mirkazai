...
class PerplexityLlama31Sonar8BOnline extends BaseDriver implements WithInputInterface, WithWordsInterface
{
    use HasInput;
    use HasWords;
    ...
    {
        return EntityEnum::PERPLEXITY_LLAMA_31_SONAR_8B_ONLINE;
    }
}
