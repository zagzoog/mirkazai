...
namespace App\Domains\Entity\Drivers\PiAPI;
...
class MidjourneyDriver extends BaseDriver implements WithImagesInterface, WithInputImageInterface
{
    use HasImages;
    use HasInputImage;
