...
namespace App\Domains\Entity\Drivers\Deepseek;
...
class DeepseekReasonerDriver extends BaseDriver implements WithInputInterface, WithWordsInterface
{
    use HasInput;
    use HasWords;
    ...
    {
        return EntityEnum::DEEPSEEK_REASONER;
    }
}
