...
<<?php echo e($tag); ?>
    ...
    <?php echo e($attributes->withoutTwMergeClasses()->twMerge($base_class, $variant, $size, $hoverVariant, $attributes->get('class'))); ?>

    <?php if($tag === 'a'): ?> href="<?php echo e($href); ?>"
<?php else: ?>
...
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/components/button.blade.php ENDPATH**/ ?>