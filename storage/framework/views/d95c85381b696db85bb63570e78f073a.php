<div
	class="mb-3"
	x-data='{
		initialModel: <?php echo json_encode($currentModel, 15, 512) ?> || "",
		selectedModel: <?php echo json_encode($currentModel, 15, 512) ?> || ""
	}'
>
...
<?php $component->withAttributes(['class' => 'w-full']); ?>
		<label class="form-label"><?php echo e(__($listLabel)); ?></label>
		<select
			class="form-select"
			id="<?php echo e($listId); ?>"
			name="<?php echo e($listId); ?>"
			@change="selectedModel = $event.target.value"
			<?php if($bedrockOptions): ?>
				onchange="toggleBedrockModel(this.value)"
			<?php endif; ?>
		>
			<?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $driver): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php if($driver->enum()->value === \App\Enums\BedrockEngine::BEDROCK->value || $driver->enum()->isEmbedding()): ?>
					<?php continue; ?>
				<?php endif; ?>
				<option
					value="<?php echo e($driver->enum()->slug()); ?>"
					<?php echo e($currentModel === $driver->enum()->slug() ? 'selected' : null); ?>

				>
					<?php echo e($driver->enum()->label()); ?>
			...
			<?php if($bedrockOptions): ?>
				<option
					value="<?php echo e(\App\Enums\BedrockEngine::BEDROCK->value); ?>"
					<?php echo e($currentModel  === \App\Enums\BedrockEngine::BEDROCK->value ? 'selected' : null); ?>

				>
					<?php echo e(\App\Enums\BedrockEngine::BEDROCK->label()); ?>
...
<?php $component->withAttributes(['class' => 'mt-2 py-5','x-show' => 'selectedModel !== initialModel']); ?>
			...
			<div
				...
				<div>
					<h3 class="mb-0 text-2xs"><?php echo e(__("Transfer Users Credits")); ?></h3>
					<p class="m-0 text-2xs opacity-80"><?php echo e(__("Click to move users credits from the old model to the new default model.")); ?></p>
				</div>
				<div class="ms-auto">
					<svg
			...
			<div
				@click="if (confirm('<?php echo e(__('Are you sure? This is permanent.')); ?>')) { updatePlansCredits($data.initialModel, $data.selectedModel); }"
				class="cursor-pointer flex items-center gap-1 rounded-xl p-5 shadow-md shadow-black/15 transition-all hover:scale-105 hover:shadow-2xl hover:shadow-black/[17%] dark:bg-heading-foreground/[20%]">
				<div>
					<h3 class="mb-0 text-2xs"><?php echo e(__("Update Plans Credits")); ?></h3>
					<p class="m-0 text-2xs opacity-80"><?php echo e(__("Click to transfers allocated credits from the old model to the new default model in plans for the new registered users.")); ?></p>
				</div>
				<div class="ms-auto">
					<svg
						xmlns="http://www.w3.org/2000/svg"
...
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/components/model-select-list-with-change-alert.blade.php ENDPATH**/ ?>