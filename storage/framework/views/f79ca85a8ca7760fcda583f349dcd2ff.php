...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.form.text','data' => ['id' => 'new_'.e($newId).'','@keyup.enter' => '$refs.submitBtn.click(); modalOpen = false','name' => 'new_'.e($name).'','size' => 'lg','xRef' => 'new_'.e($newId).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'new_'.e($newId).'','@keyup.enter' => '$refs.submitBtn.click(); modalOpen = false','name' => 'new_'.e($name).'','size' => 'lg','x-ref' => 'new_'.e($newId).'']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['x-ref' => 'submitBtn','@click' => 'newOptions.push($refs.new_'.e($newId).'.value); $refs.new_'.e($newId).'.value = \'\'; modalOpen = false;']); ?>
                            <?php echo e(__('Add')); ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/components/form/select.blade.php ENDPATH**/ ?>