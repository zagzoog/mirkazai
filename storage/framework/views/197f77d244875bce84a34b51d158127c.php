<?php $__env->startSection('title', __('Serper API Settings')); ?>
<?php $__env->startSection('titlebar_actions', ''); ?>
<?php $__env->startSection('titlebar_subtitle', __('This API key is used for these features: AI Chat, AI Web Chat, Realtime Chat')); ?>
...
<?php $component->withAttributes(['class' => 'mb-2 max-md:text-center','szie' => 'lg']); ?>
            ...
            <?php if($app_is_demo): ?>
                <div class="mb-3">
                    <label class="form-label"><?php echo e(__(':label API Key', ['label' => \App\Domains\Engine\Enums\EngineEnum::SERPER->label()])); ?></label>
                    <input
                            class="form-control"
                            id="serper_api_key"
                            type="text"
            ...
            <?php else: ?>
                <div
                    ...
                    <label class="form-label"><?php echo e(__(':label API Key', ['label' => \App\Domains\Engine\Enums\EngineEnum::SERPER->label()])); ?>
...
<?php $component = App\View\Components\Button::resolve(['variant' => 'link','href' => 'https://serper.dev'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
                    ...
                    <input
                            ...
                            type="text"
                            name="serper_api_key"
                            value="<?php echo e($settings_two->serper_api_key); ?>"
                            required
                    >
                    <?php if (isset($component)) { $__componentOriginalb5e767ad160784309dfcad41e788743b = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalb5e767ad160784309dfcad41e788743b = $attributes; } ?>
...
<?php $component->withAttributes(['class' => 'mt-2']); ?>
                        <p>
                            <?php echo e(__('Please ensure that your Serper api key is fully functional and billing defined on your Serper account.')); ?>
...
<?php endif; ?>
                    <a
                            ...
                            href="<?php echo e(route('dashboard.admin.settings.serperapi.test')); ?>"
                            target="_blank"
                    >
...
<?php endif; ?>
        ...
        <?php echo $__env->first(['seo-tool::particles.serper-seo', 'panel.admin.settings.particles.serper_seo', 'vendor.empty'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php echo $__env->make('panel.layout.settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/admin/settings/serperapi.blade.php ENDPATH**/ ?>