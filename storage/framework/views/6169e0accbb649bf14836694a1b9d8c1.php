...
<?php $component = App\View\Components\Forms\Input::resolve(['id' => 'search_str','size' => 'lg','type' => 'search','placeholder' => ''.e(__('Search for add-ons')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lqd-marketplace-search-input rounded-full bg-foreground/10 ps-10 placeholder:text-foreground']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['data-filter' => ''.e($filter).'','class' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\Illuminate\Support\Arr::toCssClasses([
...
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/admin/market/components/marketplace-filter.blade.php ENDPATH**/ ?>