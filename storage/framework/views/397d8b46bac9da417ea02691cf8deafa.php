<div class="lqd-generator-v2-editor">
    <div class="lqd-generator-editor-actions fixed inset-x-0 top-0 z-50">
        <?php echo $__env->make('panel.user.generator.components.editor-actions-top-bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
        ...
        >
            ...
            <div class="relative flex w-full items-center justify-between rounded-full bg-background pe-3">
                ...
                <input
                    ...
                    id="ai_prompt_id"
                    type="text"
                    placeholder="<?php echo e(__('Keep writing the next paragraph...')); ?>"
                >
                <button
...
<input
    ...
    type="hidden"
    name="_message_no"
    value="<?php echo e(isset($workbook) ? $workbook->id : ''); ?>"
>
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(custom_theme_url('/assets/js/panel/openai_generator_workbook.js?v=' . time())); ?>"></script>
    ...
    <script>
        function saveDocTitle(title) {
            ...
            // if (!message_no) {
            //     toastr.error("<?php echo e(__('You haven\'t created any content')); ?>")
            // }
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/generator/components/editor.blade.php ENDPATH**/ ?>