<?php $__currentLoopData = $chat->messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php if(isset($category) && ($category->slug == 'ai_vision' || $category->slug === 'ai_realtime_voice_chat') && count($chat->messages) === 1): ?>
        <?php continue; ?>
    <?php endif; ?>

    <?php if($message->input != null): ?>
    ...
    <div class="lqd-chat-ai-bubble mb-2.5 flex max-w-full content-start gap-2 last:mb-0">
        <?php if($message->output != null): ?>
            ...
            <div class="chat-content-container group relative max-w-[calc(100%-64px)] rounded-[2em] bg-clay text-heading-foreground dark:bg-white/[2%]">
                ...
                ?>
                <pre
                    class="chat-content prose relative w-full max-w-none !whitespace-pre-wrap px-6 py-3 indent-0 font-[inherit] text-xs font-normal text-current [word-break:break-word] empty:hidden [&_*]:text-current"><?php echo e($output); ?></pre>
                <div
...
<?php endif; ?>
    ...
    <?php if($message->outputImage != null && $message->outputImage != ''): ?>
        <div class="lqd-chat-image-bubble mb-2.5 flex gap-2 lg:ms-auto">
            <div class="flex w-4/5 justify-end rounded-[2em] text-heading-foreground md:w-1/2">
                <a
                    data-fslightbox="gallery"
                    data-type="image"
                    href="<?php echo e($message->outputImage); ?>"
                >
                    <img
                        class="img-content rounded-3xl"
                        loading="lazy"
                        src=<?php echo e($message->outputImage); ?>
    ...
    <div class="mb-2.5 flex content-end">
        <div class="w-full-none rounded-[2em] bg-secondary text-heading-foreground dark:bg-white/[2%]">
            <div class="chat-content px-6 py-3">
                <?php echo e(__('You have no message... Please start typing.')); ?>

            </div>
        </div>
    </div>
<?php endif; ?>
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/openai_chat/components/chat_area.blade.php ENDPATH**/ ?>