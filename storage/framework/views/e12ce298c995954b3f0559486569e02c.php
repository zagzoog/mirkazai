...
<?php $__env->startSection('titlebar_subtitle'); ?>
    <?php if($category->slug == 'ai_vision'): ?>
        <?php echo e(__('Seamlessly upload any image you want to explore and get insightful conversations.')); ?>

    <?php elseif($category->slug == 'ai_pdf'): ?>
        <?php echo e(__('Simply upload a PDF, find specific information. extract key insights or summarize the entire document.')); ?>

    <?php elseif($category->slug == 'ai_chat_image'): ?>
        <?php echo e(__('Seamlessly generate and craft a diverse array of images without ever leaving your chat environment.')); ?>

    <?php endif; ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('titlebar_actions'); ?>
	<?php echo $__env->renderWhen(! $isOtherCategories, 'components.select-ai-model-list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path'])); ?>

	<?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['href' => ''.e(LaravelLocalization::localizeUrl(route('dashboard.user.openai.list'))).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $__env->startSection('content'); ?>
    <?php if($category->slug == 'ai_webchat' && count($list) == 0): ?>
        <input
            id="createChatUrl"
            type="hidden"
            name="createChatUrl"
    ...
    <input
        ...
        value="<?php echo $__env->yieldContent('openChatAreaContainerUrl', '/dashboard/user/openai/chat/open-chat-area-container'); ?>"
    />
    ...
    <div class="py-10">
        ...
        >
            ...
            >
                <?php if(view()->hasSection('chat_sidebar')): ?>
                    <?php echo $__env->yieldContent('chat_sidebar'); ?>
                <?php else: ?>
                    <?php echo $__env->make('panel.user.openai_chat.components.chat_sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                <?php endif; ?>
            </div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'conversation-area-wrap relative flex h-[inherit] grow flex-col md:rounded-s-none lg:w-full','class:body' => 'h-full rounded-b-[inherit] rounded-t-[inherit]','id' => 'load_chat_area_container']); ?>
                 <?php $__env->slot('head', null, ['class' => '!border-none !p-0']); ?> 
                    <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['variant' => 'ghost-shadow','size' => 'none','href' => '#'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Button::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'chats-sidebar-expander absolute start-0 top-5 z-[99] hidden size-10 -translate-x-1/2 place-content-center rounded-full bg-background text-heading-foreground shadow-md shadow-heading-foreground/10 hover:translate-y-0 hover:scale-105 dark:bg-background lg:group-[&.focus-mode]/body:inline-grid','@click.prevent' => 'if ( $store.focusMode.active ) { toggleSidebarHidden() }']); ?>
                        <span
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'rtl:-scale-x-1 size-4']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                ...
                <?php if($chat != null): ?>
                    <?php if(view()->hasSection('chat_area_container')): ?>
                        <?php echo $__env->yieldContent('chat_area_container'); ?>
                    <?php else: ?>
                        <?php echo $__env->make('panel.user.openai_chat.components.chat_area_container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php endif; ?>
                <?php else: ?>
    ...
    <template id="chat_user_bubble">
        <div class="lqd-chat-user-bubble mb-2 flex flex-row-reverse content-end gap-2 lg:ms-auto">
            <span
                ...
                style="background-image: url(<?php echo e(url(Auth::user()->avatar, true)); ?>)"
            >
                <span class="sr-only">
...
<?php endif; ?>
    ...
    <template id="chat_ai_bubble">
        <div class="lqd-chat-ai-bubble group mb-2 flex content-start gap-2">
            <span
                class="lqd-chat-avatar inline-block size-6 shrink-0 rounded-full bg-cover bg-center"
                style="background-image: url('<?php echo e(!empty($chat->category->image) ? custom_theme_url($chat->category->image, true) : url(custom_theme_url('/assets/img/auth/default-avatar.png'))); ?>')"
            >
                <span class="sr-only">
                    <?php echo app('translator')->get('AI Assistant'); ?>:
                </span>
            </span>
            <div
                ...
                <div class="inline-flex max-w-full items-center rounded-full font-medium leading-none">
                    <?php if($category->slug == 'ai_chat_image'): ?>
...
<?php endif; ?>
    ...
    <input
        id="assistant"
        type="hidden"
        value="<?php echo e($category->assistant); ?>"
    />
    <input
        id="guest_id"
        type="hidden"
    ...
    <input
        id="guest_search"
        type="hidden"
        value="<?php echo e($apiSearch); ?>"
    >
    <input
        id="guest_search_id"
        type="hidden"
        value="<?php echo e($apiSearchId); ?>"
    >
    <input
        id="guest_event_id"
        type="hidden"
    ...
    >
    <?php if($category->prompt_prefix != null): ?>
        <input
            id="prompt_prefix"
            type="hidden"
            value="<?php echo e($category->prompt_prefix); ?> you will now play a character and respond as that character (You will never break character). Your name is <?php echo e($category->human_name); ?> but do not introduce by yourself as well as greetings."
        >
    <?php else: ?>
        <input
            id="prompt_prefix"
...
<?php $__env->startPush('script'); ?>
    ...
    <script src="<?php echo e(custom_theme_url('/assets/libs/html2pdf/html2pdf.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(custom_theme_url('/assets/libs/underscore/underscore-observe.js')); ?>"></script>
    <script src="<?php echo e(custom_theme_url('/assets/libs/turndown.js')); ?>"></script>
    <?php echo $__env->make('panel.user.openai_chat.components.chat_js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('panel.layout.app', ['disable_tblr' => true], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/openai_chat/chat.blade.php ENDPATH**/ ?>