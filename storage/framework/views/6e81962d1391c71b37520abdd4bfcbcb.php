<?php $__env->startSection('title', __('Update')); ?>
        ...
        <div class="container-xl">
            <div class="col-12 md:px-10">
                            ...
                            <div class="row">
                                <div class="col-12 col-md-5 max-w-[390px]">
                                    <h4 class="text-heading mb-6 w-10/12 text-[23px] leading-[1.3em]">
                                        <?php echo e(__('A newer version of')); ?> <?php echo e($setting->site_name); ?>

                                        <?php echo e(__('is available.')); ?></h4>
                                    <p class="text-heading mb-3 text-[18px] font-semibold">
                                        <strong id="update_version"><?php echo e($setting->script_version); ?></strong>
                                    </p>
                                    <a
                                            class="btn min-w-[90%] rounded-full !py-[0.65rem] px-10 text-[15px] font-medium"
                                            id="update_btn"
                                            type="button"
                                            href="<?php echo e(route('updater.index')); ?>"
                                    >
                ...
                >
                    ...
                    <div class="card-body p-10">
                        <h2><?php echo e($setting->site_name); ?> <?php echo e(__('is up to date')); ?></h2>
                    </div>
                </div>
                <p class="text-heading text-[18px] font-semibold"><?php echo e(__('Change-log')); ?></p>
                <hr class="mb-4">
...
<?php $__env->startPush('script'); ?>
    <script>
        $(document).ready(function () {
            $.ajax({
                type: 'GET',
                url: '<?php echo e(route('updater.for.panel')); ?>',
                async: false,
                success: function (response) {
                    if (response.update) {
                        // Güncelleme var ise versiyon bilgisini göster ve güncelleme rozeti ekle
...
<?php echo $__env->make('panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/admin/update/index.blade.php ENDPATH**/ ?>