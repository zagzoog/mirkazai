<?php $__env->startSection('title', __('Site Health')); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class:body' => 'flex items-start gap-3']); ?>
                                <div class="<?php echo e(backgroundColor($result->status)); ?> flex items-center justify-center rounded-full bg-opacity-25 p-1.5">
                                    <svg
                                        class="size-5 <?php echo e(iconColor($result->status)); ?>"
                                        xmlns="http://www.w3.org/2000/svg"
                                        viewBox="0 0 20 20"
                                        fill="currentColor"
                                    >
                                        <?php if(icon($result->status) == 'check-circle'): ?>
                                            <path
                                                fill-rule="evenodd"
                                ...
                                <div>
                                    ...
                                    <dt class="mt-0 text-sm font-medium text-gray-600 dark:text-gray-400">
                                        <?php if(!empty($result->notificationMessage)): ?>
                                            <?php if($result->notificationMessage === 'Crashed'): ?>
                                                <?php echo e(__('Failed to calculate. Your server configuration is preventing this feature from being calculated.')); ?>

                                            <?php else: ?>
                                                <?php echo e(str_replace('The debug mode was expected to be `false`, but actually was `true`', __('Debug mode is enabled. If this is your production site, it is recommended to disable it.'), $result->notificationMessage)); ?>
...
<?php $component = App\View\Components\Button::resolve(['variant' => 'outline','size' => 'lg'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'cleanCacheBtn']); ?>
                            <svg
                                class="mr-2"
                                xmlns="http://www.w3.org/2000/svg"
                                width="18"
...
<?php $component->withAttributes(['class' => 'mt-10']); ?>
                        <h3><?php echo e(__('Server Details')); ?></h3>
                        <label
                            class="!mb-5 block"
                            for="log"
                        ><?php echo e(__('You can copy the below info as simple text with Ctrl+C / Ctrl+V:')); ?></label>
                        <textarea
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'copyButton']); ?>
                                <svg
                                    class="mr-2"
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="18"
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginale67687e3e4e61f963b25a6bcf3983629 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale67687e3e4e61f963b25a6bcf3983629 = $attributes; } ?>
<?php $component = App\View\Components\Button::resolve(['variant' => 'outline','href' => ''.e(route('dashboard.admin.health.logs')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(App\View\Components\Button::class))->getConstructor()): ?>
...
<?php $__env->startPush('script'); ?>
    <script>
        ...
        cleanCacheBtn.addEventListener('click', function() {
            var confirmResultCache = confirm(<?php echo json_encode(__('Are you sure you want to clear the cache?'), 15, 512) ?>);
                ...
                xhr.onreadystatechange = function() {
                    if (xhr.readyState === XMLHttpRequest.DONE) {
                        if (xhr.status === 200) {
                            ...
                            alert(<?php echo json_encode(__('An error occurred while clearing the cache.'), 15, 512) ?>);
                        }
                    }
                };
                xhr.send();
    ...
    <script>
        ...
        copyButton.addEventListener('click', function() {
            ...
            toastr.success(<?php echo json_encode(__('Copied'), 15, 512) ?>);
        });
    </script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('panel.layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/admin/health/index.blade.php ENDPATH**/ ?>