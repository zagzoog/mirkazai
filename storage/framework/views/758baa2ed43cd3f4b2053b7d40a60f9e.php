<form
    action="<?php echo e(route('dashboard.user.openai.documents.new-folder')); ?>"
    method="post"
>
    <?php echo csrf_field(); ?>
...
<?php $component = App\View\Components\Forms\Input::resolve(['label' => ''.e(__('New Folder Name:')).'','name' => 'newFolderName'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/openai/components/modals/create-new-folder.blade.php ENDPATH**/ ?>