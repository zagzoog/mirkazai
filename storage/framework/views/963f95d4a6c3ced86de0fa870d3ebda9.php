<script>
	...
	function sendOpenaiGeneratorForm(ev) {
		...
		<?php endif; ?>
			...
			<?php if($openai->type == 'audio' || $openai->type == \App\Domains\Entity\Enums\EntityEnum::ISOLATOR->value): ?>
		...
		if ("<?php echo e($question->name); ?>" != "size")
		...
		$.ajax({
			...
			success: function(res) {
				...
				setTimeout(function() {
					...
					<?php elseif($openai->type == 'audio' || $openai->type == \App\Domains\Entity\Enums\EntityEnum::ISOLATOR->value): ?>
...
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/openai/scripts/common.blade.php ENDPATH**/ ?>