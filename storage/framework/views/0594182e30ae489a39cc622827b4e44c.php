...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'chats-list-container flex h-[inherit] w-full shrink-0 grow-0 flex-col overflow-hidden rounded-e-none border-e-0 max-md:absolute max-md:start-0 max-md:top-0 max-md:z-50 max-md:h-full max-md:overflow-hidden max-md:border-none max-md:bg-background/95 max-md:backdrop-blur-lg max-md:backdrop-saturate-150 max-md:transition-all max-md:duration-300 md:!flex','class:body' => 'flex flex-col h-full','id' => 'chats-list-container',':class' => '{ \'active\': mobileSidebarShow }']); ?>
...
<?php $component = App\View\Components\Forms\Input::resolve(['id' => 'chat_search_word','type' => 'search','placeholder' => ''.e(__('Search')).''] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'navbar-search-input peer rounded-full border-clay bg-clay ps-10','data-category-id' => ''.e($category->id).'','onkeydown' => 'return event.key != \'Enter\';','aria-label' => ''.e(__('Search in website')).'']); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'size-5 pointer-events-none absolute start-3 top-1/2 -translate-y-1/2 opacity-80']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
	...
	>
		<?php if(view()->hasSection('chat_sidebar_list')): ?>
			<?php echo $__env->yieldContent('chat_sidebar_list'); ?>
		<?php else: ?>
			<?php echo $__env->make('panel.user.openai_chat.components.chat_sidebar_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		<?php endif; ?>
	</div>
...
<?php $component = App\View\Components\Button::resolve(['href' => 'javascript:void(0);'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lqd-upload-doc-trigger grow text-[0.8rem]','onclick' => 'return $(\'#selectDocInput\').click();']); ?>
					<?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'lqd-new-chat-trigger grow text-[0.8rem]','onclick' => ''.$disable_actions
...
<?php endif; ?>
<?php /**PATH C:\Users\zagzo\Downloads\UniServerZ\www\resources\views/default/panel/user/openai_chat/components/chat_sidebar.blade.php ENDPATH**/ ?>